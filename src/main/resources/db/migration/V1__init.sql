...
insert into camera (id, name, customer_id, state, url) values (4, 'San Sebastian', 1, 'ONLINE', 'http://212.142.228.68/mjpg/video.mjpg');
insert into camera (id, name, customer_id, state, url) values (4, 'Fukushima', 1, 'ONLINE', 'http://dake.miemasu.net/nphMotionJpeg?Resolution=640x480&Quality=Clarity');
